...
(function (factory) {
    ...
    var dialog = renderer.create('<div class="modal model-summernote" aria-hidden="false" tabindex="-1"/>', function ($node, options) {
        if (options.fade) {
            $node.addClass('fade');
        }
        $node.html([
    ...
    $.summernote = $.extend($.summernote, {
        ...
        options: {
            ...
            fontNames: [
                ...
                '隶书','幼圆','方正舒体','方正姚体',
                '华文细黑','华文黑体','华文楷体','华文宋体','华文仿宋',
                '华文彩云','华文琥珀','华文隶书','华文行楷','华文新魏',
                'Akzidenz Grotesk',
                'Arial', 'Arial Black','Bodoni', 'Garamond','Comic Sans MS', 'Courier New',
                'Frutiger','Futura','Gill Sans',
                'Helvetica Neue', 'Helvetica', 'Impact', 'Lucida Grande',
                'Officina',
                'Tahoma','Times', 'Times New Roman','Univers', 'Verdana'
            ],
